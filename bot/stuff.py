...
#KOD NASIL EKLENİR???
            [
                Button.inline("540P", data="ffmpeg -i '''{}''' -preset superfast -c:v libx265 -crf 28 -c:a aac -vbr on -b:a 64k -s 960x540 -threads 1 '''{}'''"),
                Button.inline("720P", data="ffmpeg -i '''{}''' -preset superfast -c:v libx265 -crf 28 -c:a aac -vbr on -b:a 64k -s 1280x720 -threads 1 '''{}'''"),
#                
            ],
